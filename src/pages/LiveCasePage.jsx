    ...
    <div className="max-w-4xl mx-auto px-6 py-8 md:py-10">
      ...
      <div className="flex gap-1.5 mb-3">
        {liveCase.subjects.map((s) => (
          <span key={s} className="text-xs font-semibold uppercase tracking-wider text-[#7B2235] bg-[#F4E4E7] px-2.5 py-1 rounded-full">
            {s}
          </span>
        ))}
      </div>
      ...
      <div className="p-5 rounded-xl bg-[#FAF0F2] border-l-4 border-[#7B2235] mb-6">
        <p className="text-sm font-serif font-bold text-[#7B2235] mb-1">Why this matters</p>
