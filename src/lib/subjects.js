...
export const SUBJECTS = [
  ...
  { id: 'social-sciences', name: 'Social Sciences', icon: Users, description: 'How humans behave, organise, and shape the world', color: 'bg-violet-50 text-violet-700' },
...
export const SUBJECT_TOPICS = {
  ...
  'social-sciences': [
    { id: 'intro-social-sciences', name: 'Introduction to Social Sciences', description: 'What the social sciences are and how they investigate the world' },
    { id: 'political-science', name: 'Political Science', description: 'Power, governance, ideologies, and the state' },
    { id: 'international-relations', name: 'International Relations', description: 'States, institutions, and the dynamics of world politics' },
    { id: 'economics-society', name: 'Economics (as a lens for society)', description: 'Economic concepts as tools for understanding social life' },
    { id: 'geography', name: 'Geography', description: 'Place, people, and the patterns that connect them' },
    { id: 'anthropology', name: 'Anthropology', description: 'Culture, kinship, ritual, and the study of being human' },
    { id: 'research-methods', name: 'Research Methods in Social Sciences', description: 'How social knowledge is produced and evaluated' },
  ],
  mathematics: [
...
export const TOPIC_SUBTOPICS = {
  ...
  'intro-social-sciences': [
    { id: 'what-are-social-sciences', name: '1.1 What Are the Social Sciences?', description: 'Defining the social sciences as a family of disciplines' },
    { id: 'why-social-sciences-matter', name: '1.2 Why the Social Sciences Matter', description: 'The role of social inquiry in understanding the world' },
    { id: 'interconnectedness-of-social-sciences', name: '1.3 The Interconnectedness of the Social Sciences', description: 'How the disciplines overlap and inform each other' },
    { id: 'scientific-method-in-social-sciences', name: '1.4 The Scientific Method in the Social Sciences', description: 'Applying systematic inquiry to human behaviour' },
    { id: 'quantitative-vs-qualitative', name: '1.5 Quantitative vs. Qualitative Approaches', description: 'Two complementary ways of studying social life' },
  ],
  'political-science': [
    { id: 'what-is-political-science', name: '2.1 What Is Political Science?', description: 'The systematic study of politics and power' },
    { id: 'power-authority-legitimacy', name: '2.2 Power, Authority, and Legitimacy', description: 'How power operates and when it is accepted as legitimate' },
    { id: 'the-state-and-sovereignty', name: '2.3 The State and Sovereignty', description: 'What makes a state and how it claims authority' },
    { id: 'political-ideologies', name: '2.4 Political Ideologies', description: 'Core belief systems shaping political life' },
    { id: 'forms-of-government', name: '2.5 Forms of Government', description: 'How different polities organise rule' },
    { id: 'democracy-and-its-variants', name: '2.6 Democracy and Its Variants', description: 'Different models of democratic governance' },
    { id: 'authoritarianism-and-totalitarianism', name: '2.7 Authoritarianism and Totalitarianism', description: 'Regimes that concentrate power and limit dissent' },
    { id: 'political-parties-and-elections', name: '2.8 Political Parties and Elections', description: 'How parties compete and citizens choose leaders' },
    { id: 'civil-society-and-political-participation', name: '2.9 Civil Society and Political Participation', description: 'The role of citizens, movements, and associations' },
    { id: 'human-rights-domestic', name: '2.10 Human Rights: A Domestic Perspective', description: 'Rights as guaranteed and contested within states' },
    { id: 'political-economy', name: '2.11 Political Economy', description: 'How politics and economics shape one another' },
    { id: 'globalization-and-the-state', name: '2.12 Globalization and the State', description: 'How global forces affect state power and policy' },
  ],
  'international-relations': [
    { id: 'what-is-international-relations', name: '3.1 What Is International Relations?', description: 'The study of relations between states and beyond' },
    { id: 'the-international-system', name: '3.2 The International System: States, Sovereignty, and Anarchy', description: 'The structural setting of world politics' },
    { id: 'realism-and-neorealism', name: '3.3 Realism and Neorealism', description: 'Power, security, and the logic of competition' },
    { id: 'liberalism-and-neoliberalism', name: '3.4 Liberalism and Neoliberalism', description: 'Cooperation, institutions, and interdependence' },
    { id: 'constructivism-and-critical-theories', name: '3.5 Constructivism and Critical Theories', description: 'How ideas, identity, and power shape world politics' },
    { id: 'balance-of-power-and-hegemony', name: '3.6 Balance of Power and Hegemony', description: 'How states manage and respond to power' },
    { id: 'international-organisations', name: '3.7 International Organisations: UN, EU, NATO, WTO, IMF, World Bank', description: 'Major bodies that structure global cooperation' },
    { id: 'international-law', name: '3.8 International Law', description: 'The rules and norms that govern states' },
    { id: 'human-rights-international', name: '3.9 Human Rights: An International Perspective', description: 'Rights claimed across borders and institutions' },
    { id: 'conflict-war-and-peace', name: '3.10 Conflict, War, and Peace', description: 'Causes of conflict and pathways to peace' },
    { id: 'globalisation-and-interdependence', name: '3.11 Globalisation and Interdependence', description: 'How states and societies are increasingly intertwined' },
    { id: 'diplomacy-and-foreign-policy', name: '3.12 Diplomacy and Foreign Policy', description: 'How states pursue interests in the world' },
  ],
  'economics-society': [
    { id: 'economics-as-a-social-lens', name: '4.1 Economics as a Social Lens', description: 'Economic thinking as a way to read society' },
    { id: 'markets-supply-and-demand', name: '4.2 Markets, Supply, and Demand', description: 'How prices emerge from interaction' },
    { id: 'market-structures', name: '4.3 Market Structures: Competition, Monopoly, and In Between', description: 'How market form shapes outcomes' },
    { id: 'gdp-and-economic-growth', name: '4.4 GDP and Economic Growth', description: 'Measuring an economy and what growth means' },
    { id: 'inflation-and-its-political-stakes', name: '4.5 Inflation and Its Political Stakes', description: 'Why rising prices are a political issue' },
    { id: 'unemployment-and-the-business-cycle', name: '4.6 Unemployment and the Business Cycle', description: 'Booms, busts, and joblessness' },
    { id: 'fiscal-policy-government-spending-and-taxation', name: '4.7 Fiscal Policy: Government Spending and Taxation', description: 'How governments steer economies through budgets' },
    { id: 'monetary-policy-central-banks-and-interest-rates', name: '4.8 Monetary Policy: Central Banks and Interest Rates', description: 'How central banks shape money and credit' },
    { id: 'inequality-and-redistribution', name: '4.9 Inequality and Redistribution', description: 'Disparities of income and wealth, and policy responses' },
  ],
  geography: [
    { id: 'what-is-geography', name: '5.1 What Is Geography?', description: 'The study of places, peoples, and patterns' },
    { id: 'physical-vs-human-geography', name: '5.2 Physical vs. Human Geography', description: 'Two halves of the geographic tradition' },
    { id: 'population-and-migration', name: '5.3 Population and Migration', description: 'How people are distributed and why they move' },
    { id: 'urbanisation-and-cities', name: '5.4 Urbanisation and Cities', description: 'The rise of cities and urban life' },
    { id: 'globalisation-and-place', name: '5.5 Globalisation and Place', description: 'How global flows reshape local places' },
    { id: 'resources-and-environment', name: '5.6 Resources and the Environment', description: 'Humans, resources, and environmental limits' },
    { id: 'climate-and-society', name: '5.7 Climate and Society', description: 'Climate change and its social consequences' },
    { id: 'geopolitics-and-territory', name: '5.8 Geopolitics and Territory', description: 'Power, borders, and the politics of space' },
  ],
  anthropology: [
    { id: 'what-is-anthropology', name: '6.1 What Is Anthropology?', description: 'The holistic study of humans and human variation' },
    { id: 'culture-and-cultural-relativism', name: '6.2 Culture and Cultural Relativism', description: 'Understanding cultures on their own terms' },
    { id: 'kinship-and-social-organisation', name: '6.3 Kinship and Social Organisation', description: 'Family, descent, and how societies organise' },
    { id: 'language-and-communication', name: '6.4 Language and Communication', description: 'Language as a window onto culture and thought' },
    { id: 'religion-ritual-and-belief', name: '6.5 Religion, Ritual, and Belief', description: 'How meaning and practice shape social life' },
    { id: 'identity-race-and-ethnicity', name: '6.6 Identity, Race, and Ethnicity', description: 'How people define themselves and are defined' },
    { id: 'globalisation-and-cultural-change', name: '6.7 Globalisation and Cultural Change', description: 'How cultures meet, mix, and transform' },
    { id: 'ethnography-and-fieldwork', name: '6.8 Ethnography and Fieldwork', description: 'Studying culture by being there' },
  ],
  'research-methods': [
    { id: 'why-research-methods-matter', name: '7.1 Why Research Methods Matter', description: 'Why how you study a question shapes what you find' },
    { id: 'formulating-research-questions', name: '7.2 Formulating Research Questions', description: 'Turning interests into investigable questions' },
    { id: 'quantitative-methods', name: '7.3 Quantitative Methods', description: 'Measuring and analysing the social world' },
    { id: 'qualitative-methods', name: '7.4 Qualitative Methods', description: 'Interpreting meaning, context, and experience' },
    { id: 'mixed-methods', name: '7.5 Mixed Methods', description: 'Combining quantitative and qualitative approaches' },
